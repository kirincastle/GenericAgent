---
type: sop
title: "GA UltraPlan SOP — Multi-agent orchestration with phase-tree HTML monitor"
tags: [ultraplan, orchestration, multi-agent, planning]
intent: "UltraPlan is Python-scripted multi-agent orchestration. Covers phase tree design, parallel fan-out/fan-in, stop/continue decisions, and HTML monitor."
---
# GA UltraPlan SOP
